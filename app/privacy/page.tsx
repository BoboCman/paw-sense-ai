    ...
    <LegalPagesWrapper>
      ...
      <section id="collection">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <li>
            <span className="font-medium">Payment information</span>, such as bank account number, credit or debit card
            number, or financial account details used for payments. All payment processing services connected with your
            use of the Service are provided to you by third-party payment processors. We accept payment from Clients in
            the form of credit cards, debit cards, and e-checks. Financial Planner AI does not store any credit card or
            banking information. We are not responsible nor have any liability if you suffer any damages of any kind
            from your use of the products and services offered by Stripe, Twelve Labs, OpenAI, Anthropic, or other AI
            service providers. You agree that you are subject to the terms and conditions and privacy policies of these
            companies:
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            or inquiries, including for support, assistance, or order information, and any feedback you provide when you
            communicate with us. We and our service providers may also record or monitor any call or chat you have with
            us for quality control or training purposes, or to enforce our rights.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <li>
            <span className="font-medium">Online activity data</span>, such as pages or screens you viewed, how long you
            spent on a page or screen, navigation paths between pages or screens, information about your activity on a
            page or screen, access times, and duration of access.
          </li>
        </ul>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li>
            <span className="font-medium">Cookies</span>, which are text files that websites store on a visitor's device
            to uniquely identify the visitor's browser or to store information or settings in the browser for the
            purpose of helping you navigate between pages efficiently, remembering your preferences, enabling
          ...
          <li>
            <span className="font-medium">Local storage</span>, which is used to save data on a visitor's device. We may
            use data from local storage to, for example, turn on web navigation, store multimedia preferences, customize
            what we show you based on your past interactions with our Service, and remember your preferences.
          </li>
          <li>
            <span className="font-medium">Session-replay technologies</span>, which are third-party software programs
            that we may use on the Site to record a video replay of user's interactions with the Site. The video replay
            may include users' clicks, mouse movements, scrolls, mobile app touches, typing, and other activity taken
            during the session. We use these replays for research and development purposes, such as to help us
            troubleshoot problems with the Site, understand how users interact with and use the Site, and identify areas
            for improvement.
          </li>
        </ul>
      ...
      <section id="video-processing">
        ...
        <p className="mb-4">
          Our Service allows users to upload dog behavior videos for AI-powered analysis. This section describes how we
          handle and process these videos.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li>
            The video is transmitted securely to our AI analysis partners, including Twelve Labs, OpenAI, and Anthropic
          </li>
          ...
          <li>
            Upon completion of analysis, the original video is deleted from our AI partners' systems according to their
        ...
        <p className="mb-4">
          The results of the video analysis, including behavioral patterns, timestamps, and behavioral interpretations,
          are stored in our system to:
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
      ...
      <section id="chatbot">
        ...
        <p className="mb-4">
          ...
          conversational interfaces on our website and mobile applications. This section describes how we collect, use,
          and protect information gathered through your interactions with our chatbot.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Information We Collect Through Chatbot Interactions</h3>
        <p className="mb-4">
          When you engage with our chatbot, we collect and process the following types of information:
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Use and Processing of Chatbot Data</h3>
        <p className="mb-4">We use information collected through chatbot interactions for the following purposes:</p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <p className="mb-4">
          We may engage third-party service providers to help us deliver and improve our chatbot services. These service
          providers are contractually bound to protect your information and may only use it for the specific purposes we
          designate.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Data Retention and Security</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          We implement appropriate technical and organizational measures to protect chatbot interaction data, including:
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Your Rights and Choices Regarding Chatbot Data</h3>
        <p className="mb-4">You have the following rights regarding your chatbot interaction data:</p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Automated Decision-Making</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Special Categories of Data</h3>
        <p className="mb-4">
          Please do not share sensitive personal information (such as health information, financial account details, or
          government identification numbers) through the chatbot unless specifically requested through a secure,
      ...
      <section id="use">
        ...
        <p className="mb-4">
          Financial Planner AI uses personal information for the purposes set forth below and as otherwise described in
        ...
        <p className="mb-4">
          We may use your personal information for research and development purposes, including to study and improve the
          Service and our business, understand and analyze the usage trends and preferences of our users, and develop
          new features, functionality, products, and services. As part of these activities, we may create aggregated,
          de-identified, or other anonymous data from personal information we collect. We make personal information into
          anonymous data by removing information that makes the data personally identifiable to you. We may use this
        ...
        <p className="mb-4">
          ...
          information about you (including the online activity information and device information described above in the
          section called "Personal Information Automatically Collected") over time across our Site and other websites
          and services or your interaction with our emails, and use that information to serve ads that they think will
          interest you. In addition, some of these companies may use hashed customer lists that we share with them to
          deliver ads to you and to similar users on their platforms. You can learn more about your choices for limiting
          interest-based advertising in the "YOUR CHOICES" section below.
        </p>
